...
function InstagramFeed() {
    return(
        <div className={`instagram-feed ${styles.instagramArea}` }>
            ...
            <div id="curator-feed-default-feed-layout" className={styles.instagramFeed}><a href="https://www.instagram.com/9bordencoffee/?hl=en" rel="noreferrer" target="_blank" className="crt-logo crt-tag">Powered by Curator.io</a></div>
        </div>
    )
}
